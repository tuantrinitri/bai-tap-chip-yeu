...
@section('page_content')
    <div class="card-body">
        <form action="{{ route('banner.admin.edit', $banner['id']) }}" method="post">
            {{ csrf_field() }}
            <table class="table table-td-middle">
                <colgroup>
                    <col class="w200">
                    <col>
                </colgroup>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control w300" name="title"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group areaBrowserFile">
                                <input placeholder="Chưa chọn hình ảnh" readonly type="text" id="file_src-image"
                                    class="form-control" name="file_src"
                                    value="{{ old('file_src', $banner['file_src']) }}">
                                <div class="input-group-prepend mr-0">
                                    <button class="btn btn-light btn-sm btn-remove-file text-danger" type="button"><i
                                            class="fa fa-times"></i></button>
                                    <button class="btn btn-dark btn-sm btn-choose-file" data-id="file_src-image"
                                        type="button"><i class="fa fa-image mr-1"></i> Chọn ảnh</button>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control w300" name="link"
                    ...
                    <tr>
                        ...
                        <td class="datepicker-wrap">
                            <input placeholder="Chọn khoảng thời gian" autocomplete="off" name="available_time" type="text"
                                class="form-control daterange-basic"
                                value="{{ old('available_time', $banner['available_time']) }}">
                        </td>
                    </tr>
                </tbody>
            </table>
