        ...
        <div class="tab-content">
            <div class="tab-pane fadeshow active" id="tab-account">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3"><strong>Mật khẩu</strong> <sup
                                class="text-danger">(*)</sup></label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3"><strong>Nhập lại mật khẩu</strong> <sup
                                class="text-danger">(*)</sup></label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input autocomplete="new-password" type="text" class="form-control" name="display_name"
                                value="{{ old('display_name') }}" placeholder="Nhập tên hiển thị">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input autocomplete="new-password" type="text" class=" form-control" name="info[fullname]"
                                value="{{ old('info.fullname') }}" placeholder="Nhập họ tên">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input autocomplete="new-password" type="text" class=" form-control" name="info[phone]"
                                value="{{ old('info.phone') }}" placeholder="Nhập điện thoại">
                        </div>
                    </div>
                    <div class="form-group row">
                                    ...
                                    <div class="uniform-choice">
                                        <div class="uniform-choice">
                                            <input name="info[gender]" type="radio" class="form-check-input-styled"
                                                {{ old('info.gender', 1) == 1 ? 'checked' : '' }} value="1">
                                        </div>
                                    </div>
                                    Nam
                                </label>
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <div class="uniform-choice">
                                        <div class="uniform-choice">
                                            <input name="info[gender]" type="radio" class="form-check-input-styled"
                                                {{ old('info.gender', 1) == 2 ? 'checked' : '' }} value="2">
                                        </div>
                                    </div>
                                    Nữ
                                </label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input autocomplete="new-password" type="text" class=" form-control" name="info[address]"
                                value="{{ old('info.address') }}" placeholder="Nhập địa chỉ">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input id="isSuperAdmin" name="is_superadmin" value="1" type="checkbox"
                                    class="form-check-input-styled" {{ old('is_superadmin', 0) == 1 ? 'checked' : '' }}>
