...
<form action="{{ route('contact.topic.admin.edit',$topic['id']) }}" method="POST">
    {{ csrf_field() }}
        ...
        <div class="col-md-8 p-0" style="border-right: 1px solid #ddd">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input name="name" type="text" class="form-control" placeholder="{{ trans('contact::admin.topic_name_pla') }}" value="{{ old('name',$topic['name']) }}">
                </div>
                    ...
                    <div class="col-lg-9">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <div class="uniform-choice">
                                    <div class="uniform-choice">
                                        <input name="status" type="radio" class="form-check-input-styled" {{ $topic['status'] == 1 ? 'checked' : '' }} {{ old('status', 1) == 1 ? 'checked' : '' }} value="1">
                                    </div>
                                </div>
                        ...
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <div class="uniform-choice">
                                    <div class="uniform-choice">
                                        <input name="status" type="radio" class="form-check-input-styled" {{ $topic['status'] == 0 ? 'checked' : '' }} {{ old('status', 1) == 0 ? 'checked' : '' }} value="0">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-9">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <div class="uniform-choice">
                                    <div class="uniform-choice">
                                        <input name="mail_status" type="radio" class="form-check-input-styled" {{ $topic['mail_status'] == 1 ? 'checked' : '' }} {{ old('mail_status', 1) == 1 ? 'checked' : '' }} value="1">
                                    </div>
                                </div>
                                <span class="text-success">{{ trans('contact::admin.active') }}</span>
                            </label>
                        ...
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <div class="uniform-choice">
                                    <div class="uniform-choice">
                                        <input name="mail_status" type="radio" class="form-check-input-styled" {{ $topic['mail_status'] == 0 ? 'checked' : '' }} {{ old('mail_status', 1) == 0 ? 'checked' : '' }} value="0">
                                    </div>
                                </div>
                                <span class="text-danger">{{ trans('contact::admin.deactive') }}</span>
                            </label>
                ...
                <div class="form-group">
                    ...
                    <textarea name="note" class="form-control" placeholder="{{ trans('contact::admin.note_pla') }}" rows="3">{{ old('note',$topic['note']) }}</textarea>
                </div>
                <hr>
                <div class="form-group row">
                    <label class="col-form-label col-lg-3"><strong>{{ trans('contact::admin.mail_title') }}</strong> <sup class="text-danger">(*)</sup></label>
                    <div class="col-lg-9">
                        <input name="mail_title" value="{{ old('mail_title',$topic['mail_title']) }}" type="text" class="form-control" placeholder="{{ trans('contact::admin.mail_title_pla') }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-lg-12"><strong>{{ trans('contact::admin.mail_content') }}</strong> <sup class="text-danger">(*)</sup></label>
                    <div class="col-lg-12">
                        <textarea id="content" name="mail_content" rows="3" class="form-control">{{ old('mail_content',$topic['mail_content']) }}</textarea>
                    </div>
                </div>
                <div class="text-center">
                    <a href="{{ route('contact.topic.admin.list') }}" class="btn btn-dark">{{ trans('contact::admin.cancel') }}</a>
                    <button type="submit" class="btn btn-primary">{{ trans('contact::admin.save') }}</button>
                </div>
            </div>
        </div>
