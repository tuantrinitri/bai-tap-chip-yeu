        ...
        <div class="card card-sidebar-mobile">
            ...
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                @foreach ($menus = dashboard_menu()->getAll() as $menu)
                    ...
                    <li class="nav-item @if (isset($menu->children) &&
                        $menu->children->count()) nav-item-submenu @if ($menu->active) nav-item-expanded nav-item-open @endif @endif"
                            id="{{ $menu->id }}">
                            <a href="{{ $menu->url }}" class="nav-link nav-toggle @if ($menu->active) active @endif"><i
                                    class="{{ $menu->icon }}"></i>
