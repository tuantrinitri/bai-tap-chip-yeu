            ...
            <div class="col-md-8 p-0" style="border-right: 1px solid #ddd">
                <div class="card-body">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input placeholder="{{ trans('post::post.slug') }}" id="txtSlug" type="text"
                                    ...
                                    value="{{ isset($data['slug']) ? old('slug', $data['slug']) : old('slug') }}"
                                    {!! isset($data['slug']) ? 'readonly' : '' !!}>
                                <div class="input-group-prepend mr-0">
                                    <a href="javascript:;" onclick="get_slug('#txtTitle', '#txtSlug');"
                                        class="btn btn-dark btn-sm" {!! isset($data['slug']) ? 'style=display:none;' : 'style=display:block;' !!}><em class="fa fa-sync"></em></a>
                                    {!! isset($data['slug']) ? '' : '' !!}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-12">
                            <textarea id="content"
                                name="content">{{ isset($data['content']) ? old('content', $data['content']) : old('content') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
